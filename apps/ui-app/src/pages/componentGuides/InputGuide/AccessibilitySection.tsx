...
const inputSizeOptions = ['small', 'medium', 'large'] as const;
...
type InputSize = (typeof inputSizeOptions)[number];
...
export const AccessibilitySection = () => {
  ...
  const [showEndAdornment, setShowEndAdornment] = useState(true);
  ...
  const accessibilityInput = useMemo(
    () => (
      <Input
        aria-label={label}
        disabled={disabled}
        endAdornment={showEndAdornment ? <span>.com</span> : undefined}
        fullWidth={fullWidth}
        placeholder={placeholder}
        size={size}
        startAdornment={
          showStartAdornment ? <IconMoon aria-hidden /> : undefined
        }
        ...
        <div className={styles.controls}>
          ...
          <label className={styles.checkbox}>
            <input
              ...
              onChange={(event) => setShowStartAdornment(event.target.checked)}
              type="checkbox"
            />
            Start adornment
          </label>
          ...
          <label className={styles.checkbox}>
            <input
              ...
              onChange={(event) => setShowEndAdornment(event.target.checked)}
              type="checkbox"
            />
            End adornment
          </label>
